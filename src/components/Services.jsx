    ...
    return (
        ...
        <div className="w-100 bg-red-100"  >
            <div className="py-4 h-auto lg:w-10/12 mx-auto" >
                <motion.div className="md:w-50 mx-auto text-center" initial={{ y: 70, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }}>
                ...
                <motion.h3 initial={{ x: -100, opacity: 0 }} whileInView={{ x: 0, opacity: 1 }} className=" pt-10 text-center text-4xl font-Mont font-bold text-gray-600">We Repair - </motion.h3>

                <motion.div initial={{ y: 70, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} className="flex flex-col my-5 space-x-5 space-y-10 lg1:space-y-0 lg1:flex-row lg1:px-10">
