    ...
    return (
        ...
        <div className="w-100 bg-red-100"  >
            <div className="py-4 h-auto lg:w-10/12 mx-auto" >
                <motion.div className="md:w-50 mx-auto text-center" initial={{ y: 10, opacity: 0 }} viewport={{ once: true }} whileInView={{ y: 0, opacity: 1 }}>
                ...
                <motion.h3 initial={{ y: -10, opacity: 0 }} viewport={{ once: true }} whileInView={{ y: 0, opacity: 1 }} className=" pt-10 text-center text-4xl font-Mont font-bold text-gray-600">We Repair - </motion.h3>

                <motion.div initial={{ opacity: 0 }} viewport={{ once: true }} whileInView={{opacity: 1 }} className="flex flex-col my-5 space-x-5 space-y-10 lg1:space-y-0 lg1:flex-row lg1:px-10">
                    ...
                    <div className="w-10/12 mx-auto sm:flex sm:flex-row bg-slate-200 shadow shadow-violet-400 font-semibold">
                        ...
                        <div className="w-100 sm:w-8/12 sm:flex sm:items-center sm:justify-center bg-slate-600">
                            <img src={oven} alt="microwave oven repair service in bhopal" className="mx-auto w-44 sm:w-full p-2 sm:self-center my-auto hover:scale-110" />
                        </div>
                    </div>
                ...
                <motion.div initial={{ y: 70, opacity: 0 }} viewport={{ once: true }} whileInView={{ y: 0, opacity: 1 }} className="flex flex-col my-5 space-x-5 space-y-10 lg1:space-y-0 lg1:flex-row lg1:px-10">

                    <div className="w-10/12 bg-slate-600 mx-auto shadow shadow-violet-400 sm:flex sm:flex-row">
                        <div className="py-10 sm:py-0 w-auto sm:w-auto bg-slate-200 sm:flex sm:items-center sm:justify-center" >
