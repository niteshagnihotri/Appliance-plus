...
const Cform = () => {
    ...
    return (
        <div className={form ? "hidden ": "w-100 absolute flex justify-center text-stone-50 flex-col  space-y-5 "}>       
            <Form ref={contactform} className=" w-4/12 mx-auto bg-slate-500  p-10">
            <div className="flex justify-end">            
                <GrClose className='w-12 h-6 cursor-pointer hover:text-slate-50' onClick={hideForm} />
            </div>
