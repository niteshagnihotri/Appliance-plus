        ...
        <div className="w-100 h-auto flex items-center bg-slate-800 text-white lg1:py-14 py-5">
            <div className="lg:w-10/12 mx-auto">
                <div className="flex flex-col-reverse lg1:flex-row">
                    <motion.div initial={{x: -50, opacity:0}} viewport={{ once: true }} whileInView={ {x: 0, opacity:1} } className="sm:mx-10 px-3">
                    ...
                    <motion.div initial={{y: 50,  opacity:0}} viewport={{ once: true }} whileInView={ {y: 0,  opacity:1} } className="flex w-100 items-start mr-5 ">
