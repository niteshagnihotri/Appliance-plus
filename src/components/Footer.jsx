            ...
            <div className="lg:w-10/12 mx-auto xl:px-32 lg:px-0 lg1:px-3">
                <div className="mx-3 sm:mx-5 md:flex md:flex-row md:justify-between space-y-16 md:space-y-0">
                    ...
                    <div className="space-y-10 ">
                        ...
                        <div>
                            <span className="text-2xl">Available 24 X 7 -  <Link to="" style={{ textDecoration: "underline gray", color: "white" }} className='hover:text-slate-400 underline-offset-4' onClick={() => window.location = 'tel:+917224930506'}>+917224930506</Link></span>
                        </div>
                    </div>
                </div>
            </div>
            <div className="w-100 mt-5 py-2 px-2 text-sm  text-left sm:p-10 text-gray-400 leading-8 sm:leading-loose">
            Copyright © Applianceplus 2022. All right reserved. Designed & Developed by <Link to="//niteshagnihotri.netlify.app/" className="no-underline text-slate-300">Nitesh Agnihotri</Link>
            </div>
        </div>
