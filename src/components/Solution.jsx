    ...
    return (
        ...
        <div className="w-100 py-10 h-auto md:h-[80vh] bg-pink-50 md:py-16">
            <div className="py-4 h-auto lg:w-10/12 mx-auto ">
                ...
                <div className="w-auto md:w-100 flex md:flex-row md:justify-center mt-12 md:mt-20 md:space-x-9 md:space-y-0 xl:space-x-14 font-QuickSand flex-col space-x-0 space-y-5 ">
