        ...
        <div className="w-100 py-10 h-auto md:h-[80vh] bg-pink-50 md:py-16">
            <div className="py-4 h-auto lg:w-10/12 mx-auto ">
                <div className="text-center space-y-5 xl:space-y-10 font-bold  px-2">
                    <h3 className="text-4xl leading-tight md:text-5xl font-bold font-Raleway">
                ...
                <div className="w-auto md:w-100 flex md:flex-row md:justify-center mt-12 md:mt-20 md:space-x-9 md:space-y-0 xl:space-x-14 font-QuickSand flex-col space-x-0 space-y-8 ">
                    <div className="shadow-xl shadow-red-200 text-center space-y-4 border-0 p-4 sm:p-10 bg-red-200 max-w-fit w-fit block sm:mx-6 mx-3 hover:shadow-2xl hover:shadow-red-400">
                    ...
                    <div className="shadow-xl shadow-yellow-200 text-center space-y-4 border-0 p-4 sm:p-10 bg-yellow-200 w-auto block sm:mx-6 mx-3 hover:shadow-2xl hover:shadow-yellow-400">
                    ...
                    <div className="shadow-xl shadow-green-200 text-center space-y-4 border-0 p-4 sm:p-10 bg-green-200 w-auto block sm:mx-6 mx-3 hover:shadow-2xl hover:shadow-green-400">
